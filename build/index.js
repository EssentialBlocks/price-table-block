...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ribbonBorderShadow", function() { return ribbonBorderShadow; });
var __ = wp.i18n.__;
...
var ribbonBorderShadow = "ribbonBrdSdw";
...
/*!****************************************************!*\
  !*** ./src/constants/typographyPrefixConstants.js ***!
  \****************************************************/
/*! exports provided: typoPrefix_button, typoPrefix_title, typoPrefix_subtitle, typoPrefix_price_title, typoPrefix_price_currency, typoPrefix_saleprice, typoPrefix_saleprice_currency, typoPrefix_pricing_period, typoPrefix_features_text, typoPrefix_ribbon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "typoPrefix_ribbon", function() { return typoPrefix_ribbon; });
...
var typoPrefix_ribbon = "ribbonText";
...
var edit = function edit(props) {
  ...
  var blockId = attributes.blockId,
      ...
      ribbonBackgroundColor = attributes.ribbonBackgroundColor; // wrapper styles css in strings
  ...
  var _generateBackgroundCo = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateBackgroundControlStyles"])({
    ...
    controlName: _constants__WEBPACK_IMPORTED_MODULE_2__["priceTableBackground"]
      ...
      priceTableBgTransitionStyle = _generateBackgroundCo.bgTransitionStyle,
      priceTableOvlTransitionStyle = _generateBackgroundCo.ovlTransitionStyle;
  ...
  var _generateBackgroundCo2 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateBackgroundControlStyles"])({
    ...
    noMainBgi: true
      ...
      buttonBackgroundStylesDesktop = _generateBackgroundCo2.backgroundStylesDesktop,
      buttonHoverBackgroundStylesDesktop = _generateBackgroundCo2.hoverBackgroundStylesDesktop,
      buttonBackgroundStylesTab = _generateBackgroundCo2.backgroundStylesTab,
      buttonHoverBackgroundStylesTab = _generateBackgroundCo2.hoverBackgroundStylesTab,
      buttonBackgroundStylesMobile = _generateBackgroundCo2.backgroundStylesMobile,
      buttonHoverBackgroundStylesMobile = _generateBackgroundCo2.hoverBackgroundStylesMobile,
      buttonOverlayStylesDesktop = _generateBackgroundCo2.overlayStylesDesktop,
      buttonHoverOverlayStylesDesktop = _generateBackgroundCo2.hoverOverlayStylesDesktop,
      buttonOverlayStylesTab = _generateBackgroundCo2.overlayStylesTab,
      buttonHoverOverlayStylesTab = _generateBackgroundCo2.hoverOverlayStylesTab,
      buttonOverlayStylesMobile = _generateBackgroundCo2.overlayStylesMobile,
      buttonHoverOverlayStylesMobile = _generateBackgroundCo2.hoverOverlayStylesMobile;
  ...
  var _generateResponsiveRa5 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateResponsiveRangeStyles"])({
    controlName: _constants__WEBPACK_IMPORTED_MODULE_2__["headerIconSize"],
    property: "font-size",
    attributes: attributes
  }),
      headerIconSizeDesktop = _generateResponsiveRa5.rangeStylesDesktop,
      headerIconSizeTab = _generateResponsiveRa5.rangeStylesTab,
      headerIconSizeMobile = _generateResponsiveRa5.rangeStylesMobile;

  var _generateResponsiveRa6 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateResponsiveRangeStyles"])({
    controlName: _constants__WEBPACK_IMPORTED_MODULE_2__["headerIconWidth"],
    property: "width",
    attributes: attributes
  }),
      headerIconWidthDesktop = _generateResponsiveRa6.rangeStylesDesktop,
      headerIconWidthTab = _generateResponsiveRa6.rangeStylesTab,
      headerIconWidthMobile = _generateResponsiveRa6.rangeStylesMobile;

  var _generateResponsiveRa7 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateResponsiveRangeStyles"])({
    controlName: _constants__WEBPACK_IMPORTED_MODULE_2__["headerIconHeight"],
    property: "height",
    attributes: attributes
  }),
      headerIconHeightDesktop = _generateResponsiveRa7.rangeStylesDesktop,
      headerIconHeightTab = _generateResponsiveRa7.rangeStylesTab,
      headerIconHeightMobile = _generateResponsiveRa7.rangeStylesMobile;

  var _generateBorderShadow3 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateBorderShadowStyles"])({
    controlName: _constants__WEBPACK_IMPORTED_MODULE_2__["iconBorderShadow"],
    attributes: attributes
  }),
      iconBorderShadowDesktop = _generateBorderShadow3.styesDesktop,
      iconBorderShadowTab = _generateBorderShadow3.styesTab,
      iconBorderShadowMobile = _generateBorderShadow3.styesMobile,
      iconBorderShadowHoverDesktop = _generateBorderShadow3.stylesHoverDesktop,
  ...
  var _generateTypographySt10 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateTypographyStyles"])({
    attributes: attributes,
    prefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_3__["typoPrefix_ribbon"]
  }),
      ribbonTypoStylesDesktop = _generateTypographySt10.typoStylesDesktop,
      ribbonTypoStylesTab = _generateTypographySt10.typoStylesTab,
      ribbonTypoStylesMobile = _generateTypographySt10.typoStylesMobile;

  var _generateBorderShadow4 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateBorderShadowStyles"])({
    controlName: _constants__WEBPACK_IMPORTED_MODULE_2__["ribbonBorderShadow"],
    attributes: attributes
  }),
      ribbonBorderShadowDesktop = _generateBorderShadow4.styesDesktop,
      ribbonBorderShadowTab = _generateBorderShadow4.styesTab,
      ribbonBorderShadowMobile = _generateBorderShadow4.styesMobile,
      ribbonBorderShadowHoverDesktop = _generateBorderShadow4.stylesHoverDesktop,
      ribbonBorderShadowHoverTab = _generateBorderShadow4.stylesHoverTab,
      ribbonBorderShadowHoverMobile = _generateBorderShadow4.stylesHoverMobile;

  var desktopStyles = "\n\t\t.".concat(blockId, " .eb-pricing {\n\t\t\ttext-align: ").concat(contentAlign, ";\n\t\t\t").concat(ribbonStyle === "ribbon-4" ? "overflow: hidden;" : "", "\n\t\t}\n\n\t\t.").concat(blockId, ".eb-pricing-content-left .eb-pricing.style-3 .eb-pricing-item .header:after, .").concat(blockId, ".eb-pricing-content-left .eb-pricing.style-3 .eb-pricing-item .eb-pricing-tag:after {\n\t\t\ttransform: translateX(-80%);\n\t\t}\n\n\t\t.").concat(blockId, ".eb-pricing-content-right .eb-pricing.style-3 .eb-pricing-item .header:after, .").concat(blockId, ".eb-pricing-content-right .eb-pricing.style-3 .eb-pricing-item .eb-pricing-tag:after {\n\t\t\ttransform: translateX(80%);\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-1::before {\n\t\t\tcontent: \"\";\n\t\t\tcolor: ").concat(ribbonColor, ";\n\t\t\tbackground: ").concat(ribbonBackgroundColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-2::before,\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-3::before,\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-4::before {\n\t\t\t").concat(ribbonTypoStylesDesktop, "\n\t\t\t").concat(ribbonBorderShadowDesktop, "\n\t\t\tcontent: \"").concat(ribbonText, "\";\n\t\t\tcolor: ").concat(ribbonColor, ";\n\t\t\tbackground: ").concat(ribbonBackgroundColor, ";\n\t\t\ttext-align: center;\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing:hover .eb-pricing-item.ribbon-2::before,\n\t\t.").concat(blockId, " .eb-pricing:hover .eb-pricing-item.ribbon-3::before,\n\t\t.").concat(blockId, " .eb-pricing:hover .eb-pricing-item.ribbon-4::before {\n\t\t\t").concat(ribbonBorderShadowHoverDesktop, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-2::after {\n\t\t\tborder-bottom: 15px solid ").concat(ribbonBackgroundColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item {\n\t\t\t").concat(wrapperPaddingStylesDesktop, "\n\t\t\t").concat(wrapperMarginStylesDesktop, "\n\t\t\t").concat(priceTableBackgroundStylesDesktop, "\n\t\t\t").concat(bdShadowStyesDesktop, "\n\t\t\ttransition: ").concat(priceTableBgTransitionStyle, ", ").concat(bdShadowTransitionStyle, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing-item-overlay::before  {\n\t\t\t").concat(priceTableOverlayStylesDesktop, "\n\t\t\ttransition: ").concat(priceTableOvlTransitionStyle, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item:hover {\n\t\t\t").concat(priceTableHoverBackgroundStylesDesktop, "\n\t\t\t").concat(bdShadowStylesHoverDesktop, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item:hover .eb-pricing-item-overlay:before {\n\t\t\t").concat(priceTableHoverOverlayStylesDesktop, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header {\n\t\t\t").concat(titlePaddingStylesDesktop, "\n\t\t\t").concat(titleMarginStylesDesktop, "\n\t\t\tbackground: ").concat(titleBackgroundColor, ";\n\t\t\tposition: relative;\n\t\t\tz-index: 0;\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header .eb-pricing-title {\n\t\t\t").concat(titleTypoStylesDesktop, "\n\t\t\tcolor: ").concat(titleTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header .eb-pricing-subtitle {\n\t\t\t").concat(subtitleTypoStylesDesktop, "\n\t\t\tcolor: ").concat(subtitleTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .original-price {\n\t\t\t").concat(priceTextTypoStylesDesktop, "\n\t\t\tcolor: ").concat(priceTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .original-price .price-currency {\n\t\t\t").concat(priceCurrencyTypoStylesDesktop, "\n\t\t\t").concat(priceCurrencyMarginStylesDesktop, "\n\t\t\tcolor: ").concat(priceCurrencyTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .price-period {\n\t\t\t").concat(pricePeriodTypoStylesDesktop, "\n\t\t\tcolor: ").concat(pricingPeriodTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .sale-price {\n\t\t\t").concat(salePriceTypoStylesDesktop, "\n\t\t\tcolor: ").concat(salePriceTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .sale-price .price-currency {\n\t\t\t").concat(salePriceCurrencyTypoStylesDesktop, "\n\t\t\t").concat(salePriceMarginStylesDesktop, "\n\t\t\tcolor: ").concat(salepriceCurrencyTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .body ul li, .").concat(blockId, " .eb-pricing .eb-pricing-item .body ul li a {\n\t\t\t").concat(featuresTypoStylesDesktop, "\n\t\t\tcolor: ").concat(featuresTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .body ul li .eb-pricebox-icon {\n\t\t\t").concat(featuresIconSizeDesktop, "\n\t\t\tmargin-right: 8px;\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button-wrapper {\n\t\t\t").concat(buttonMarginStylesDesktop, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button {\n\t\t\t").concat(buttonPaddingStylesDesktop, "\n\t\t\t").concat(buttonTypoStylesDesktop, "\n\t\t\t").concat(buttonBackgroundStylesDesktop, "\n\t\t\t").concat(btnShadowStyesDesktop, "\n\t\t\tcolor: ").concat(buttonTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button:before {\n\t\t\t").concat(buttonOverlayStylesDesktop, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button:hover {\n\t\t\t").concat(btnShadowStylesHoverDesktop, "\n\t\t\t").concat(buttonHoverBackgroundStylesDesktop, "\n\t\t\tcolor: ").concat(hoverTextColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button:hover:before {\n\t\t\t").concat(buttonHoverOverlayStylesDesktop, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button i {\n\t\t\t").concat(buttonIconPosition === "left" ? buttonIconSpaceRightDesktop : buttonIconSpaceLeftDesktop, "\n\t\t\t").concat(buttonIconSizeDesktop, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-icon {\n\t\t\tdisplay: flex;\n\t\t\talign-items: center;\n\t\t\tjustify-content: ").concat(contentAlign === "left" ? "flex-start" : contentAlign === "right" ? "flex-end" : "center", ";\n\t\t}\n\t\t\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-icon .icon {\n\t\t\tdisplay: flex;\n\t\t\talign-items: center;\n\t\t\tjustify-content: center;\n\t\t\t").concat(headerIconWidthDesktop, "\n\t\t\t").concat(headerIconHeightDesktop, "\n\t\t\t").concat(iconBorderShadowDesktop, "\n\t\t\t").concat(showIconBackground ? "background-color: " + iconBackgroundColor + ";" : "background-color: transparent;", "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item:hover .eb-pricing-icon .icon {\n\t\t\t").concat(iconBorderShadowHoverDesktop, "\n\t\t\t").concat(showIconBackground ? "background-color: " + iconBackgroundHoverColor + ";" : "background-color: transparent;", "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-icon .icon i {\n\t\t\t").concat(headerIconSizeDesktop, "\n\t\t\tcolor: ").concat(iconColor, ";\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item:hover .eb-pricing-icon .icon i {\n\t\t\tcolor: ").concat(iconHoverColor, ";\n\t\t}\n\t");
  var tabStyles = "\n\t\t.".concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-2::before,\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-3::before,\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-4::before {\n\t\t\t").concat(ribbonTypoStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item {\n\t\t\t").concat(wrapperPaddingStylesTab, "\n\t\t\t").concat(wrapperMarginStylesTab, "\n\t\t\t").concat(priceTableBackgroundStylesTab, "\n\t\t\t").concat(bdShadowStyesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing-item-overlay:before {\n\t\t\t").concat(priceTableOverlayStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item:hover {\n\t\t\t").concat(priceTableHoverBackgroundStylesTab, "\n\t\t\t").concat(bdShadowStylesHoverTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing-item:hover .eb-pricing-item-overlay:before {\n\t\t\t").concat(priceTableHoverOverlayStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header {\n\t\t\t").concat(titlePaddingStylesTab, "\n\t\t\t").concat(titleMarginStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header .eb-pricing-title {\n\t\t\t").concat(titleTypoStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header .eb-pricing-subtitle {\n\t\t\t").concat(subtitleTypoStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .original-price {\n\t\t\t").concat(priceTextTypoStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .original-price .price-currency {\n\t\t\t").concat(priceCurrencyTypoStylesTab, "\n\t\t\t").concat(priceCurrencyMarginStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .price-period {\n\t\t\t").concat(pricePeriodTypoStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .sale-price {\n\t\t\t").concat(salePriceTypoStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .sale-price .price-currency {\n\t\t\t").concat(salePriceCurrencyTypoStylesTab, "\n\t\t\t").concat(salePriceMarginStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .body ul li {\n\t\t\t").concat(featuresTypoStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .body ul li .eb-pricebox-icon {\n\t\t\t").concat(featuresIconSizeTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button-wrapper {\n\t\t\t").concat(buttonMarginStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button {\n\t\t\t").concat(buttonPaddingStylesTab, "\n\t\t\t").concat(buttonTypoStylesTab, "\n\t\t\t").concat(buttonBackgroundStylesTab, "\n\t\t\t").concat(btnShadowStyesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button:hover {\n\t\t\t").concat(buttonHoverBackgroundStylesTab, "\n\t\t\t").concat(btnShadowStylesHoverTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button:before {\n\t\t\t").concat(buttonOverlayStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button:hover:before {\n\t\t\t").concat(buttonHoverOverlayStylesTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button i {\n\t\t\t").concat(buttonIconPosition === "left" ? buttonIconSpaceRightTab : buttonIconSpaceLeftTab, "\n\t\t\t").concat(buttonIconSizeTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-icon .icon {\n\t\t\t").concat(headerIconWidthTab, "\n\t\t\t").concat(headerIconHeightTab, "\n\t\t\t").concat(iconBorderShadowTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-icon .icon:hover {\n\t\t\t").concat(iconBorderShadowHoverTab, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-icon .icon i {\n\t\t\t").concat(headerIconSizeTab, "\n\t\t}\n\t");
  var mobileStyles = "\n\t\t.".concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-2::before,\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-3::before,\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item.ribbon-4::before {\n\t\t\t").concat(ribbonTypoStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item {\n\t\t\t").concat(wrapperPaddingStylesMobile, "\n\t\t\t").concat(wrapperMarginStylesMobile, "\n\t\t\t").concat(priceTableBackgroundStylesMobile, "\n\t\t\t").concat(bdShadowStyesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing-item-overlay:before {\n\t\t\t").concat(priceTableOverlayStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item:hover {\n\t\t\t").concat(priceTableHoverBackgroundStylesMobile, "\n\t\t\t").concat(bdShadowStylesHoverMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing-item:hover .eb-pricing-item-overlay:before {\n\t\t\t").concat(priceTableHoverOverlayStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header {\n\t\t\t").concat(titlePaddingStylesMobile, "\n\t\t\t").concat(titleMarginStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header .eb-pricing-title {\n\t\t\t").concat(titleTypoStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header .eb-pricing-subtitle {\n\t\t\t").concat(subtitleTypoStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .original-price {\n\t\t\t").concat(priceTextTypoStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .original-price .price-currency {\n\t\t\t").concat(priceCurrencyTypoStylesMobile, "\n\t\t\t").concat(priceCurrencyMarginStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .price-period {\n\t\t\t").concat(pricePeriodTypoStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .sale-price {\n\t\t\t").concat(salePriceTypoStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-tag .sale-price .price-currency {\n\t\t\t").concat(salePriceCurrencyTypoStylesMobile, "\n\t\t\t").concat(salePriceMarginStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .body ul li {\n\t\t\t").concat(featuresTypoStylesMobile, "\n\t\t}\n\t\t\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .body ul li .eb-pricebox-icon {\n\t\t\t").concat(featuresIconSizeMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button-wrapper {\n\t\t\t").concat(buttonMarginStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button {\n\t\t\t").concat(buttonPaddingStylesMobile, "\n\t\t\t").concat(buttonTypoStylesMobile, "\n\t\t\t").concat(buttonBackgroundStylesMobile, "\n\t\t\t").concat(btnShadowStyesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button:hover {\n\t\t\t").concat(buttonHoverBackgroundStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button:before {\n\t\t\t").concat(buttonOverlayStylesMobile, "\n\t\t}\n\t\t\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button:hover:before {\n\t\t\t").concat(buttonHoverOverlayStylesMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .footer .eb-pricing-button i {\n\t\t\t").concat(buttonIconPosition === "left" ? buttonIconSpaceRightMobile : buttonIconSpaceLeftMobile, "\n\t\t\t").concat(buttonIconSizeMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-icon .icon {\n\t\t\t").concat(headerIconWidthMobile, "\n\t\t\t").concat(headerIconHeightMobile, "\n\t\t\t").concat(iconBorderShadowMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-icon .icon:hover {\n\t\t\t").concat(iconBorderShadowHoverMobile, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .eb-pricing-icon .icon i {\n\t\t\t").concat(headerIconSizeMobile, "\n\t\t}\n\t");
  var titleLineStyle = "";

  if (showTitleLine) {
    titleLineStyle = "\n\t\t.".concat(blockId, " .eb-pricing .eb-pricing-item .header::after {\n\t\t\tbackground: ").concat(titleLineColor, "\n\t\t}\n\n\t\t.").concat(blockId, " .eb-pricing .eb-pricing-item .header::after {\n\t\t\tcontent: \"\";\n\t\t\tposition: absolute;\n\t\t\twidth: 140px;\n\t\t\theight: 1px;\n\t\t\tbottom: 0px;\n\t\t\tleft: 0px;\n\t\t\tright: 0px;\n\t\t\tmargin: 0 auto;\n\t\t\tz-index: 1;\n\t\t}\n\n\t\t.").concat(blockId, ".eb-pricing-content-left .eb-pricing-item .header::after,\n\t\t.").concat(blockId, ".eb-pricing-content-left .eb-pricing-item .eb-pricing-tag::after {\n\t\t\tmargin: 0;\n\t\t}\n\n\t\t.").concat(blockId, ".eb-pricing-content-right .eb-pricing-item .header::after,\n\t\t.").concat(blockId, ".eb-pricing-content-right .eb-pricing-item .eb-pricing-tag::after {\n\t\t\tmargin: 0 0 0 auto;\n\t\t}\n\n\t\t.eb-pricing.style-3 .eb-pricing-item .header:after {\n\t\t\tposition: absolute;\n\t\t\tcontent: \"\";\n\t\t\twidth: 100%;\n\t\t\theight: 1px;\n\t\t\tbottom: 0px;\n\t\t\tleft: 0px;\n\t\t\tright: 0px;\n\t\t\tmargin: 0 auto;\n\t\t\tz-index: 1;\n\t\t\t-webkit-transition: 1s;\n\t\t\t-o-transition: 1s;\n\t\t\ttransition: 1s;\n\t\t\t-webkit-transform: scaleX(0.4);\n\t\t\t-ms-transform: scaleX(0.4);\n\t\t\ttransform: scaleX(0.4);\n\t\t}\n\t");
  } // ribbon Class
  ...
  return [/*#__PURE__*/React.createElement(BlockControls, null, /*#__PURE__*/React.createElement(AlignmentToolbar, {
    ...
    className: "".concat(blockId, " eb-pricing-content-").concat(contentAlign)
  }, /*#__PURE__*/React.createElement("div", {
    className: "eb-pricing ".concat(pricingStyle)
  }, /*#__PURE__*/React.createElement("div", {
    className: "eb-pricing-item".concat(ribbonClass)
  }, /*#__PURE__*/React.createElement("div", {
    className: "eb-pricing-item-overlay"
    ...
    className: "eb-pricing-title"
  }, title), showSubtitle && /*#__PURE__*/React.createElement("span", {
    className: "eb-pricing-subtitle"
  }, subtitle)), pricingStyle !== "style-3" && /*#__PURE__*/React.createElement("div", {
    className: "eb-pricing-tag"
  }, /*#__PURE__*/React.createElement("span", {
    className: "price-tag"
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }))), pricingStyle === "style-3" && /*#__PURE__*/React.createElement("div", {
    className: "eb-pricing-tag"
  }, /*#__PURE__*/React.createElement("span", {
    className: "price-tag"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    "data-period-separator": periodSeparator,
    "data-price-period": pricePeriod
  }, periodSeparator, " ", pricePeriod)), showButton && /*#__PURE__*/React.createElement("div", {
    className: "footer",
    "data-icon": buttonIcon
  }, /*#__PURE__*/React.createElement("div", {
    className: "eb-pricing-button-wrapper"
...
registerBlockType("price-table-block/pricing-table", {
  ...
  description: __("EB Pricing Table will let you create effective product pricing table with perfect styling to get more sales from your prospective buyers.", "price-table-block"),
  icon: _icon__WEBPACK_IMPORTED_MODULE_3__["default"],
  category: "widgets",
  attributes: _attributes__WEBPACK_IMPORTED_MODULE_2__["default"],
  keywords: [__("eb price", "price-table-block"), __("table", "price-table-block"), __("comparison", "price-table-block")],
...
var Inspector = function Inspector(_ref) {
  ...
  var resOption = attributes.resOption,
      ...
      ribbonText = attributes.ribbonText,
      ribbonColor = attributes.ribbonColor,
      ribbonBackgroundColor = attributes.ribbonBackgroundColor; // this useEffect is for setting the resOption attribute to desktop/tab/mobile depending on the added 'eb-res-option-' class only the first time once
  ...
  var onFeatureAdd = function onFeatureAdd() {
    var count = attributes.features.length + 1;
  ...
  return /*#__PURE__*/React.createElement(InspectorControls, {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }), /*#__PURE__*/React.createElement("hr", null)), /*#__PURE__*/React.createElement(PanelBody, {
      title: __("Features"),
      initialOpen: false
    ...
    }, __("Add Feature", "price-table-box")))), /*#__PURE__*/React.createElement(PanelBody, {
      title: __("Button"),
      initialOpen: false
    }, /*#__PURE__*/React.createElement(ToggleControl, {
      ...
      className: "eb-control-title"
    }, __("Padding & Margin"))), /*#__PURE__*/React.createElement(_util_dimensions_control_v2__WEBPACK_IMPORTED_MODULE_8__["default"], {
      resRequiredProps: resRequiredProps,
      ...
      baseLabel: __("Typography"),
      typographyPrefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_1__["typoPrefix_ribbon"],
      resRequiredProps: resRequiredProps
    }), /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_5__["default"], {
      label: __("Color"),
      color: ribbonColor,
    ...
    }), /*#__PURE__*/React.createElement(_util_border_shadow_control__WEBPACK_IMPORTED_MODULE_11__["default"], {
      controlName: _constants__WEBPACK_IMPORTED_MODULE_0__["ribbonBorderShadow"],
      resRequiredProps: resRequiredProps,
      noBorder: true
    }))));
  })));
